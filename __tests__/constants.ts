...
export const TEST_AUTHOK_CLIENT_QUERY_STRING = `&authokClient=${encodeURIComponent(
  btoa(
    JSON.stringify({
      name: 'authok-spa-js',
      version: version
...
export const TEST_DOMAIN = 'authok_domain';
export const TEST_CLIENT_ID = 'authok_client_id';
...
export const GET_TOKEN_SILENTLY_LOCK_KEY = 'authok.lock.getTokenSilently';
